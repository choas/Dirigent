...
impl DirigentApp {
    pub(super) fn render_code_viewer(&mut self, ctx: &egui::Context) {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            let mut implement_click_line: Option<usize> = None;
                        ...
                        if line_response.clicked() {
                            ...
                            if cmd && !shift_held {
                                ...
                                if symbol_lines.contains_key(&line_num) {
                                    implement_click_line = Some(line_num);
                                }
                            }
                        }
            ...
            // Handle click on a symbol line: pre-fill cue input with "Implement <name>"
            if let Some(line) = implement_click_line {
